...
from app.io import load_incidents, parquet_safe, select_labeled_columns, to_inference_frame
from app.report import build_resolved_stats, build_severity_breakdown, write_report_json
from app.report_excel import write_excel_report
...
def run_pipeline(
    ...
    step("aggregate", "running", "Индекс проблемности по открытым обращениям (итог ≠ решено/разъяснено/перенаправлено)")
    ...
    resolved_stats = build_resolved_stats(labeled)

...
export function districtFromReport(data) {
  return {
    ...
    problems: (data.themes_stat || []).map((t) => ({
      ...
      count: t.count,
      totalCount: t.total_count ?? null,
      resolvedPct: t.resolved_pct ?? null,
    })),
    ...
    resolvedPct: data.resolved_pct ?? null,
    resolvedCount: data.resolved_count ?? null,
    problemCount: data.problem_count ?? null,
  }
}
